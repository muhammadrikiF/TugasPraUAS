...
public class comic {
    ...
    public comic(){
        try {
            ...
            rs = st.executeQuery("SELECT * FROM comic ORDER BY no_id");
            if(rs.next()){
                id_buku = rs.getString("no_id");
                judul_buku = rs.getString("judul_comic");
    ...
    public void add(){
        String sql = "INSERT INTO comic VALUES "
    ...
    public void edit(){
        String sql = "UPDATE comic SET judul_comic = '"
    ...
    public void delete(){
        String sql = "DELETE FROM comic WHERE no_id = '"+id_buku+"'";
        try {
    ...
    public void search(){
        String sql = "SELECT * FROM comic WHERE judul_comic = '"+judul_buku+"'";
        try {
