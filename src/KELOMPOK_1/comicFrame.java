 ...
 *
 */
public class comicFrame extends javax.swing.JFrame {
    
    comic c = new comic();
    /** Creates new form comicFrame */
    public comicFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        comicComboBox = new javax.swing.JComboBox();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("category : [ comic ]");
        ...
        PanelModule.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "comic", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Showcard Gothic", 0, 12))); // NOI18N
        ...
        judulLabel.setText("judul comic");
        ...
        comicComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "[ comic yang tersedia ]", "- - - - - - - - - - - - - - - - - - - - - - - - - -", "Detective Conan", "Slam Dunk", "Hunter x Hunter", "Naruto", "Samurai X", "Doraemon", "Ghost at School", "Death Note", "One Piece", "Great Teacher Onizuka" }));
                    ...
                    .addGroup(PanelModuleLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelModuleLayout.createSequentialGroup()
                                .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(comicComboBox, 0, 154, Short.MAX_VALUE)
                ...
                .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelModuleLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(comicComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(PanelModuleLayout.createSequentialGroup()
                        .addComponent(judulLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
// window activated
    idbukuTextField.setText(c.id_buku);
    comicComboBox.setSelectedItem(c.judul_buku);
    pengarangTextField.setText(c.pengarang);
    penerbitTextField.setText(c.penerbit);
    hargaTextField.setText(c.harga);
...
// sewa
    c.id_buku = idbukuTextField.getText();
    c.judul_buku = comicComboBox.getSelectedItem().toString();
    c.harga = hargaTextField.getText();
    c.sewa();
    
    JOptionPane.showMessageDialog(null,"Buku '' "+comicComboBox.getSelectedItem().toString()+" '' telah di prosses");
...
// add
    if(addButton.getText().equals("+ add")){
        idbukuTextField.setText("");
        comicComboBox.setSelectedItem("[ comic yang tersedia ]");
        ...
        c.id_buku = idbukuTextField.getText();
        c.pengarang = pengarangTextField.getText();
        c.penerbit = penerbitTextField.getText();
        c.judul_buku = comicComboBox.getSelectedItem().toString();
        c.harga = hargaTextField.getText();
        c.add();
        
        JOptionPane.showMessageDialog(null,"Buku '' "+comicComboBox.getSelectedItem().toString()+" '' has been Saved ");
        comicFrame cF = new comicFrame();
        cF.show();
        dispose();
        addButton.setText("+ add");
...
// delete
    int delete = JOptionPane.showConfirmDialog(null, "hapus buku ''"+comicComboBox.getSelectedItem().toString()+"'' ?","confirmasi delete reccord",JOptionPane.YES_NO_OPTION);
...
// search
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(comicFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new comicFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox comicComboBox;
