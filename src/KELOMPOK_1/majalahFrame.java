 ...
 * 
 */
public class majalahFrame extends javax.swing.JFrame {
    
    majalah m = new majalah();

    /** Creates new form majalahFrame */
    public majalahFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        judulMajalahTextField = new javax.swing.JTextField();
        ...
        anakRadioButton = new javax.swing.JRadioButton();
        remajaRadioButton = new javax.swing.JRadioButton();
        ...
        PanelModule.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "majalah", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Showcard Gothic", 0, 12))); // NOI18N
        ...
        moduleLabel.setText("majalah untuk :");

        dosenLabel.setText("penerbit");
        ...
        judulLabel.setText("judul majalah");
        ...
        anakRadioButton.setText("anak-anak");

        remajaRadioButton.setText("remaja");
                ...
                .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelModuleLayout.createSequentialGroup()
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(penerbitTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                            .addComponent(dosenLabel))
                        .addGap(28, 28, 28)
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(PanelModuleLayout.createSequentialGroup()
                                .addComponent(anakRadioButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(remajaRadioButton))
                            .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelModuleLayout.createSequentialGroup()
                                    .addComponent(judulMajalahTextField)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(PanelModuleLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelModuleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(PanelModuleLayout.createSequentialGroup()
                                ...
                                .addComponent(dosenLabel))
                            .addGroup(PanelModuleLayout.createSequentialGroup()
                                .addComponent(judulMajalahTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(moduleLabel)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
// sewa
    ...
    m.judul_majalah = judulMajalahTextField.getText();
    m.harga = hargaTextField.getText();
    m.sewa();
    
    JOptionPane.showMessageDialog(null,"Buku '' "+judulMajalahTextField.getText()+" '' telah di prosses");
    majalahFrame mF = new majalahFrame();
    mF.show();
    dispose();
...
// window activated
    anakRadioButton.setSelected(false);
    remajaRadioButton.setSelected(false);
    
    if(m.majalah_untuk.equals("remaja")){
        idbukuTextField.setText(m.id_buku);
        judulMajalahTextField.setText(m.judul_majalah);
        penerbitTextField.setText(m.penerbit);
        remajaRadioButton.setSelected(true);
...
// add
    if(addButton.getText().equals("+ add")){
        ...
        if(anakRadioButton.isSelected()){
            m.id_buku = idbukuTextField.getText();
            m.judul_majalah = judulMajalahTextField.getText();
            m.penerbit = penerbitTextField.getText();
            m.majalah_untuk = anakRadioButton.getText();
            m.harga = hargaTextField.getText();
            m.add();
            
            JOptionPane.showMessageDialog(null,"Buku '' "+judulMajalahTextField.getText()+" '' has been Saved ");
            majalahFrame mF = new majalahFrame();
            mF.show();
            dispose();
            ...
            m.judul_majalah = judulMajalahTextField.getText();
            m.penerbit = penerbitTextField.getText();
            m.majalah_untuk = remajaRadioButton.getText();
            m.harga = hargaTextField.getText();
            m.add();
            ...
            JOptionPane.showMessageDialog(null,"isi majalah untuk :"+"\n"+"anak-anak atau remaja !");    
    }
...
// delete
    int delete = JOptionPane.showConfirmDialog(null, "hapus buku ''"+judulMajalahTextField.getText()+"'' ?","confirmasi delete reccord",JOptionPane.YES_NO_OPTION);
...
// search
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(majalahFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new majalahFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JRadioButton anakRadioButton;
    ...
    private javax.swing.JTextField judulMajalahTextField;
    ...
    private javax.swing.JRadioButton remajaRadioButton;
